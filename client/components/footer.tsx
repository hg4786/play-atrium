                    ...
                    <ScrollAnimation variant="scale" delay={0.1}>
                        <div className="flex flex-col items-center space-y-6">
                            ...
                            <div className="text-beige text-base md:text-lg space-y-1">
                                Where families play, connect, and celebrate together.
                            </div>
                        </div>
                    </ScrollAnimation>
                    ...
                    <ScrollAnimation variant="fadeUp" delay={0.3}>
                        <div className="text-center space-y-4">
                            ...
                            <a
                                ...
                                className="text-beige text-sm md:text-md underline hover:text-olive transition-colors block"
                            >
