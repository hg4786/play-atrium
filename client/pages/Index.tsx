  ...
  return (
    ...
    >
      <div className="bg-beige border-b border-olive px-6 py-6 text-center">
        ...
        <p className="font-poppins text-[64px] text-olive font-medium leading-none">$19.99</p>
      </div>
      <div className="px-6 py-6 space-y-4">
        <div className="flex items-start gap-5">
          <Star className="w-5 h-5 text-olive fill-olive flex-shrink-0 mt-1" />
    ...
    >
      <div className="flex flex-col items-center space-y-6 max-w-[320px]">
        ...
        <div className="border border-golden lg:p-4 rounded-lg w-full">
          <p className="text-golden text-base lg:text-lg leading-[25px]">{note}</p>
        </div>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          transition={{ duration: 0.2 }}
          className="bg-[#F5DFC3] text-[#657150] px-7 py-3 rounded-full font-poppins font-semibold text-lg border border-[#A5AA9C] hover:bg-[#F5EBD2] transition-colors"
        >
          Choose Plan
        </motion.button>
      </div>
...
function DecorativeStarsTestimonials() {
  return (
    <>
      ...
      <svg
        className="absolute right-0 top-0 w-[706px] h-auto opacity-80 pointer-events-none hidden lg:block"
        viewBox="0 0 706 680"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
